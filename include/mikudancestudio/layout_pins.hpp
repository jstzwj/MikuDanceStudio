...
MIKUDANCESTUDIO_APP_OFF(cameraPosition[0], 820);
MIKUDANCESTUDIO_APP_OFF(cameraPosition[1], 824);
MIKUDANCESTUDIO_APP_OFF(cameraPosition[2], 828);
...
// Frame pump 7FF7CB447612..7FF7CB44762C; InitDefaults
// 7FF7CB42C5CC..7FF7CB42C5FF and 7FF7CB42C6B7.
MIKUDANCESTUDIO_APP_OFF64(fpsOverlayFrameCount, 0x35C);
MIKUDANCESTUDIO_APP_OFF64(framesPerSecond, 0x360);
MIKUDANCESTUDIO_APP_OFF64(v32c, 0x364);
MIKUDANCESTUDIO_APP_OFF64(playbackActive, 0x368);
MIKUDANCESTUDIO_APP_OFF64(cameraPosition[0], 0x36C);
MIKUDANCESTUDIO_APP_OFF64(cameraPosition[1], 0x370);
MIKUDANCESTUDIO_APP_OFF64(cameraPosition[2], 0x374);
MIKUDANCESTUDIO_APP_OFF64(cameraReferenceMode, 0x378);
MIKUDANCESTUDIO_APP_OFF64(playbackLoopEnabled, 0x379);
MIKUDANCESTUDIO_APP_OFF64(playbackReturnsToStartFrame, 0x37A);
MIKUDANCESTUDIO_APP_OFF64(viewportToolHovered, 0x37C);
MIKUDANCESTUDIO_APP_OFF64(viewToolDragOperation, 0x380);
MIKUDANCESTUDIO_APP_OFF64(interactionDragMode, 0x384);
MIKUDANCESTUDIO_APP_OFF64(boneCopyRecords, 0x388);
