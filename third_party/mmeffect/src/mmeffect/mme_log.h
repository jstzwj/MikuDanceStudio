...
//
// The log surface is the in-memory history and its attached dialog; logging
// does not open a file or require directory-specific initialization.
#pragma once
...
// clear the MessageBox dedup set (the only state
...
// The log dialog (mme_dlg) registers a mirror that receives
